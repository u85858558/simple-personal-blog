                        ...
                        @if($post->created_at <= now()->subMonths(6))
                            <div class="p-2">
                                <div
                                    ...
                                    <span
                                        class="inline-flex items-center justify-center h-6 px-3 text-white bg-blue-600 rounded-full">Информация</span>
                                    <span class="inline-flex px-2">Этот пост старше 6 месяцев. Некоторая информация может быть устаревшей.</span>
                                </div>
                            </div>
                        @endif
                    </div>
