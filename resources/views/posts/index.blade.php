<x-app-layout>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:ps-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="-my-8 divide-y-2 divide-gray-100">

                        @foreach($posts as $post)
                            <div class="flex flex-wrap py-8 md:flex-nowrap"></div>
                                <div class="flex flex-col flex-shrink-0 mb-6 mb:w-64 mb:mb-0">
                                    @if ($post->image)
                            ...
                            <div class="md:flex-grow">
                                ...
                                <x-nav-link href="{{ route('posts.show', $post) }}">Прочитать больше
